...
def create_app_ui():
    app.layout=html.Div(
        [
            ...
            html.Div(id='val_transfer'),
            html.Div(id='val_transfer1'),
...
def open_page2(pathname):
    if pathname=='/page-2':
        ...
        'align-items':'center','justify-content':'center'},
            ...
            html.H2(children='Please verify Mobile number',
        ...
        'align-items':'center','justify-content':'center'},
            ...
            html.H1(children='Welcome to AdmitKard',style={'margin-left':'480px'}),
...
@app.callback(
    Output('val_transfer','children'),
    [Input('number1','value'),
     Input('number','value')
     ]
    )
def val_t(invalue,cvalue):
    if invalue!=None and cvalue!=None:
        newvalue=str(cvalue)+str(invalue)
        return 'An OTP is sent to ',newvalue
    else:
        pass
    
@app.callback(
    Output('hi','children'),
    [Input('val_transfer','children')
     ]
    )
def new_up(val):
    return val
